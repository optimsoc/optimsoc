...
%With each of them you will find
%a reference box (\referencebox{Component}). This box will be used
%throughout the user guide to highlight that a section covers this
%component.
