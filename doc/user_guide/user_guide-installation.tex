...
scratch, because two options are available:
...
installation path you can either build it manually, as described in
the reference manual, or you can relocate the installation that
contains static references (untested).

Follow these steps:

\begin{alltt}
\$> cd /opt
\$> mkdir optimsoc-toolchain
