...
% XXX: Add information about udev rules required for device permissions
...
Congratulations, you've run OpTiMSoC on real hardware for the first time! Now
you're ready to explore and customize OpTiMSoC for yourself. Have fun!
