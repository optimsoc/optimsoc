...
You can find this example in \path{tbench/dm/compute_tile}. You
...
The demonstration software is bundled in the \path{optimsoc/apps}
...
\path{$OPTIMSOC_APPS/baremetal/hello/hello.elf}.
...
\begin{docnote}
If the \verb|hello.vmem| file is not built, ensure that you have the
\verb|bin2vmem| tool in your \verb|PATH| as described in
...
such a system in \path{tbench/rtl/dm} directory as
...
file \path{baremetal-libraries/src/libbaremetal/include/optimsoc-baremetal.h}.
