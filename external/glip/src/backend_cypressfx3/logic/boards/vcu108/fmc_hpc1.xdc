...
# I/O timing constraints to/from the FX3 board
# The constraints are a bit less conservative than the ones given by cypress
# in order to come to a synthesizable design and have been tested.
create_clock -period 9.999 -name VIRTUAL_clk_out1_clk_wiz_0 -waveform {0.000 4.999}
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay 0.000 [get_ports {fx3_dq[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 5.000 [get_ports {fx3_dq[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay 0.000 [get_ports fx3_com_rst]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 5.000 [get_ports fx3_com_rst]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay 0.000 [get_ports fx3_flaga_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 5.000 [get_ports fx3_flaga_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay 0.000 [get_ports fx3_flagb_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 5.000 [get_ports fx3_flagb_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay 0.000 [get_ports fx3_flagc_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 5.000 [get_ports fx3_flagc_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay 0.000 [get_ports fx3_flagd_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 5.000 [get_ports fx3_flagd_n]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay 0.000 [get_ports fx3_logic_rst]
set_input_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 5.000 [get_ports fx3_logic_rst]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay -0.500 [get_ports {fx3_a[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 3.000 [get_ports {fx3_a[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay 0.000 [get_ports {fx3_dq[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 3.000 [get_ports {fx3_dq[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay -0.500 [get_ports fx3_pktend_n]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 3.000 [get_ports fx3_pktend_n]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay 0.000 [get_ports fx3_sloe_n]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 5.000 [get_ports fx3_sloe_n]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay -0.500 [get_ports fx3_slrd_n]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 3.000 [get_ports fx3_slrd_n]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -min -add_delay -0.500 [get_ports fx3_slwr_n]
set_output_delay -clock [get_clocks VIRTUAL_clk_out1_clk_wiz_0] -max -add_delay 3.000 [get_ports fx3_slwr_n]
