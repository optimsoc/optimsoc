...
const uint32_t _optimsoc_system_dynclock = 1; // not needed

// NoC parameters
const uint16_t _optimsoc_noc_maxpacketsize = 8;

// Compute tiles
const uint32_t _optimsoc_compute_tile_memsize = 128*1024;
const uint16_t _optimsoc_compute_tile_num = 1;
const uint16_t _optimsoc_compute_tiles[] = { 0 };
const uint8_t _optimsoc_max_cores_per_compute_tile = 1;
const uint32_t _optimsoc_stacksize = 0x2000;

// Memory tiles
const uint32_t _optimsoc_mainmem_size = 128*1024;

// Hostlink tiles
const uint8_t  _optimsoc_has_hostlink = 1;
const uint8_t  _optimsoc_hostlink = 1;
