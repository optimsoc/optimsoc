...
add_file -verilog "$OPTIMSOC_RTL/ct_ram/verilog/ct_ram.v"
add_file -verilog "$OPTIMSOC_RTL/ct_ram/verilog/ct_ram_plain.v"
...
add_file -verilog "$SYNDIR/bram_infer.v"
add_file -xilinx  "$SYNDIR/bram_256kB.ngc"
add_file -verilog "$SYNDIR/bram_256kB.v"
...
project -result_file "./rev_1_15b_bram/system_simpledemo_pgas_ztex115d_bram.edf"
