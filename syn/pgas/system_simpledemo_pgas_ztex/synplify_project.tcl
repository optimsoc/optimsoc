...
optimsoc_add_file $SYNDIR/system_simpledemo_pgas_ztex.ucf
optimsoc_add_file $SYNDIR/system_simpledemo_pgas_ztex.fdc
...
optimsoc_add_file $SYNDIR/system_simpledemo_pgas_ztex_ddr.ucf
...
set_option -ucf "$SYNDIR/system_simpledemo_pgas_ztex.ucf"

#automatic place and route (vendor) options
set_option -write_apr_constraint 1

#set result format/file last
project -result_file "./rev_1_15b_bram/system_simpledemo_pgas_ztex115b_bram.edf"
...
set_option -resource_sharing 1
set_option -multi_file_compilation_unit 1
set_option -ucf "$SYNDIR/system_simpledemo_pgas_ztex.ucf $SYNDIR/system_simpledemo_pgas_ztex_ddr.ucf"

#automatic place and route (vendor) options
set_option -write_apr_constraint 1

#set result format/file last
project -result_file "./rev_1_15b_ddr/system_simpledemo_pgas_ztex115b_ddr.edf"
