...
add_file -verilog "$OPTIMSOC_RTL/compute_tile_dm/verilog/compute_tile_dm.v"
add_file -verilog "$OPTIMSOC_RTL/compute_tile_dm/verilog/compute_tile_dm_bus.v"
add_file -verilog "$OPTIMSOC_RTL/compute_tile_dm/verilog/compute_tile_dm_bus_arbiter.v"
...
add_file -verilog "$OPTIMSOC_RTL/sram/verilog/sram_sp_impl_plain.v"
...
add_file -verilog "$LISNOC_RTL/meshs/lisnoc_mesh2x2.v"
...
add_file -verilog "$OPTIMSOC_RTL/debug_system/verilog/mam_wb_adapter.v"
add_file -verilog "$OPTIMSOC_RTL/debug_system/verilog/mam.v"
...
# System
add_file -ucf "$SYNDIR/system_2x2_cccc_ztex.ucf"
add_file -constraint "$SYNDIR/system_2x2_cccc_ztex.sdc"

add_file -verilog "$SYNDIR/system_2x2_cccc_ztex.v"
add_file -verilog "$OPTIMSOC_RTL/system_2x2_cccc_dm/verilog/system_2x2_cccc_dm.v"
