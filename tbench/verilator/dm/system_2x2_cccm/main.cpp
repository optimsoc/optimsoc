#include "obj_dir/Vtb_system_2x2_cccm__Syms.h"
...
{
    Vtb_system_2x2_cccm system("system");
    ...
    system.v->u_ram->sp_ram->gen_sram_sp_impl__DOT__u_impl->do_readmemh();
    ...
    VerilatedDebugConnector debugconn("DebugConnector", 0xd921);
