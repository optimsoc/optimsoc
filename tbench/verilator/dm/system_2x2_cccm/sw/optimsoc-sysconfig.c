...
// Compute tiles
const uint32_t _optimsoc_compute_tile_memsize = 1*1024*1024;
const uint16_t _optimsoc_compute_tile_num = 3;
const uint16_t _optimsoc_compute_tiles[] = { 0, 1, 2 };
...
const uint32_t _optimsoc_mainmem_tile = 3;
