...
python2 ~/optimsoc-sources/external/opensocdebug/software/src/bindings/python/examples/runelf.py --no-ctm --verify-memload cam_demo.elf
./convert_to_img.py
./decode/decode image.rgb565.raw image.rgb
convert -depth 8 -size "1600x1200" image.rgb image.png
